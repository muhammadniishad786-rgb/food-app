            ...
            {state.cart.map((food) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-orange-500 font-bold mt-2">$13</p>
                  ...
                  <div className="flex items-center gap-3 mt-4">
                    <button
                      ...
                      className="h-9 w-9 rounded-full bg-gray-100 flex items-center justify-center hover:bg-orange-500 hover:text-white transition"
                    >
                      <Minus size={16} />
                    </button>
          ...
          <div className="bg-white rounded-3xl shadow-md p-8 h-fit">
            ...
            <div className="space-y-4 text-gray-600">
              ...
              <div className="flex justify-between text-xl font-bold text-gray-800">
                <span>Total</span>
                <span className="text-orange-500">${subtotal + 3}</span>
              </div>
            </div>
