      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500 mt-4 max-w-2xl mx-auto">
            Hand-picked meals prepared with fresh ingredients and delivered
          ...
          {foods.map((food) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <button className="mt-6 w-full bg-orange-500 hover:bg-orange-600 text-white py-3 rounded-xl flex items-center justify-center gap-2 font-semibold transition">
